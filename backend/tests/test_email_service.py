...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_attach_document_uses_correct_filename(mock_exists, mock_file, email_service, sample_campaign):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_send_campaign_results_sends_email(mock_exists, mock_file, mock_smtp, email_service, sample_campaign):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_send_campaign_results_raises_error_on_auth_failure(mock_exists, mock_file, mock_smtp, email_service, sample_campaign):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_send_campaign_results_raises_error_on_smtp_failure(mock_exists, mock_file, mock_smtp, email_service, sample_campaign):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_send_campaign_results_uses_starttls(mock_exists, mock_file, mock_smtp, email_service, sample_campaign):
