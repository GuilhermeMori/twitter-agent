...
def test_validate_search_config_rejects_profile_search_without_profiles(validator, valid_profile_campaign):
...
def test_validate_search_config_rejects_profile_search_with_whitespace_only(validator, valid_profile_campaign):
...
def test_validate_search_config_rejects_profile_search_with_empty_after_parsing(validator, valid_profile_campaign):
...
def test_validate_search_config_rejects_keyword_search_without_keywords(validator, valid_keyword_campaign):
...
def test_validate_search_config_rejects_keyword_search_with_whitespace_only(validator, valid_keyword_campaign):
...
def test_validate_search_config_rejects_keyword_search_with_empty_after_parsing(validator, valid_keyword_campaign):
