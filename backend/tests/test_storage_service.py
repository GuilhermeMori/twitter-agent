...
def test_upload_document_uploads_file(mock_exists, mock_file, storage_service, mock_supabase_client):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_upload_document_uses_correct_storage_path(mock_exists, mock_file, storage_service, mock_supabase_client):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_upload_document_sets_correct_content_type(mock_exists, mock_file, storage_service, mock_supabase_client):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_upload_document_raises_error_on_upload_failure(mock_exists, mock_file, storage_service, mock_supabase_client):
...
@patch('builtins.open', new_callable=mock_open, read_data=b'fake docx content')
@patch('os.path.exists')
def test_upload_document_opens_file_in_binary_mode(mock_exists, mock_file, storage_service, mock_supabase_client):
