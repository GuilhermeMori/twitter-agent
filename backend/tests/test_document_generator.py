...
def test_generate_creates_document(
    mock_tempfile,
    mock_document_class,
    document_generator,
    sample_campaign,
...
@patch("src.services.document_generator.Document")
@patch("tempfile.NamedTemporaryFile")
def test_generate_adds_all_sections(
    mock_tempfile,
    mock_document_class,
    document_generator,
    sample_campaign,
...
@patch("src.services.document_generator.Document")
@patch("tempfile.NamedTemporaryFile")
def test_generate_handles_empty_tweets(
    mock_tempfile, mock_document_class, document_generator, sample_campaign, sample_analysis
):
...
@patch("src.services.document_generator.Document")
@patch("tempfile.NamedTemporaryFile")
def test_header_includes_campaign_name(
    mock_tempfile,
    mock_document_class,
    document_generator,
    sample_campaign,
...
@patch("src.services.document_generator.Document")
@patch("tempfile.NamedTemporaryFile")
def test_configuration_section_added(
    mock_tempfile,
    mock_document_class,
    document_generator,
    sample_campaign,
...
@patch("src.services.document_generator.Document")
@patch("tempfile.NamedTemporaryFile")
def test_tweets_section_handles_no_tweets(
    mock_tempfile, mock_document_class, document_generator, sample_campaign, sample_analysis
):
    ...
    heading_calls = [call for call in mock_doc.add_heading.call_args_list]
    assert any(
        "Collected Tweets" in str(call) or "tweets" in str(call).lower() for call in heading_calls
    )
...
@patch("src.services.document_generator.Document")
@patch("tempfile.NamedTemporaryFile")
def test_analysis_section_added(
    mock_tempfile,
    mock_document_class,
    document_generator,
    sample_campaign,
