...
def test_analyze_returns_analysis_for_valid_tweets(analysis_engine, mock_openai_client, sample_tweets):
...
def test_analyze_handles_openai_rate_limit_error(analysis_engine, mock_openai_client, sample_tweets):
...
def test_analyze_calls_openai_with_correct_parameters(analysis_engine, mock_openai_client, sample_tweets):
