...
class CommentValidator:
    ...
    def validate(
        self, comment: str, communication_style: CommunicationStyle, tweet_author: str
                ...
                for rule in communication_style.formatting_rules:
                    ...
                    if "no emoji" in rule_lower or "🚫" in rule:
                        if self._contains_emoji(comment):
                            errors.append(
                                "Comment contains emojis (forbidden by communication style)"
                            )
                    ...
                    if "no link" in rule_lower:
                        if self._contains_url(comment):
                            errors.append(
                                "Comment contains links (forbidden by communication style)"
                            )
                    ...
                    if char_limit_match:
                        ...
                        if char_count > max_chars:
                            errors.append(
                                f"Comment exceeds communication style limit of {max_chars} characters"
                            )
